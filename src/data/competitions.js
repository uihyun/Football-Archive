...
const competitions = {
	...
	'WC Qualifiers Europe': {order: 4, name: 'World Cup Qualifiers', sh: 'WCQ', type: 'Q', group: 0},
	'WC Qualifiers South America': {order: 4, name: 'World Cup Qualifiers', sh: 'WCQ', type: 'Q', group: 0},
	'WC Qualifiers CONCACAF': {order: 4, name: 'World Cup Qualifiers', sh: 'WCQ', type: 'Q', group: 0},
	'WC Qualifiers Africa': {order: 4, name: 'World Cup Qualifiers', sh: 'WCQ', type: 'Q', group: 0},
	'WC Qualifiers Asia': {order: 4, name: 'World Cup Qualifiers', sh: 'WCQ', type: 'Q', group: 0},
	'EURO Qualifiers': {order: 5, name: 'EURO Qualifiers', sh: 'CCQ', type: 'Q', group: 1},
	'Gold Cup Quali.': {order: 5, name: 'Gold Cup Qualifiers', sh: 'CCQ', type: 'Q', group: 1},
	'Copa America Qualifiers': {order: 5, name: 'Copa América Qualifiers', sh: 'CCQ', type: 'Q', group: 1},
	'Africa Cup Qual.': {order: 2, name: 'Africa Cup Qualifiers', sh: 'CC', type: 'Q', group: 1},
	'Asian Cup Qual.': {order: 2, name: 'Asian Cup Qualifiers', sh: 'CC', type: 'Q', group: 1},
