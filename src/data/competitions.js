...
const competitions = {
	...
	'WC Qualifiers Europe': {order: 4, name: 'WC Qualifiers Europe', sh: 'WCQ', type: 'Q', group: 0, times: [2016, 2017], year: 'span'},
	'WC Qualifiers South America': {order: 4, name: 'WC Qualifiers South America', sh: 'WCQ', type: 'Q', group: 0, times: [2015, 2016, 2017], year: 'span'},
	'WC Qualifiers CONCACAF': {order: 4, name: 'WC Qualifiers CONCACAF', sh: 'WCQ', type: 'Q', group: 0, times: [2015, 2016, 2017], year: 'span'},
	'WC Qualifiers Africa': {order: 4, name: 'WC Qualifiers Africa', sh: 'WCQ', type: 'Q', group: 0, times: [2015, 2016, 2017], year: 'span'},
	'WC Qualifiers Asia': {order: 4, name: 'WC Qualifiers Asia', sh: 'WCQ', type: 'Q', group: 0, times: [2015, 2016, 2017], year: 'span'},
	'EURO Qualifiers': {order: 5, name: 'EURO Qualifiers', sh: 'EUQ', type: 'Q', group: 1, times: [2014, 2015], year: 'span'},
	...
	'Africa Cup Qual.': {order: 2, name: 'Africa Cup Qualifiers', sh: 'AFQ', type: 'Q', group: 1, times: [2014, 2015, 2016, 2017, 2018, 2019], url: 'Africa-Cup-Qual', year: 'span'},
	'Africa Cup Qualifiers': {times: [2014, 2015, 2016, 2017, 2018, 2019], url: 'Africa-Cup-Qual'},
	'Asian Cup Qual.': {order: 2, name: 'Asian Cup Qualifiers', sh: 'ASQ', type: 'Q', group: 1, times: [2013, 2014], url: 'Asian-Cup-Qual', year: 'span'},
	'Asian Cup Qualifiers': {times: [2013, 2014], url: 'Asian-Cup-Qual'},
	'Nations League A': {order: 6, name: 'Nations League A', sh: 'NL', type: 'Q', group: 1, times: [2018, 2019], year: 'span'},
	'Nations League B': {order: 6, name: 'Nations League B', sh: 'NL', type: 'Q', group: 1, times: [2018, 2019], year: 'span'},
	'Nations League C': {order: 6, name: 'Nations League C', sh: 'NL', type: 'Q', group: 1, times: [2018, 2019], year: 'span'},
